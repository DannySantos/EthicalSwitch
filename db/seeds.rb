...
@tag_ethical_switch = Tag.find_or_create_by(name: "Ethical Switch")
@tag_ethical_power = Tag.find_or_create_by(name: "Ethical Power")
@tag_ethical_switch = Tag.find_or_create_by(name: "Ethical Super")
@tag_ethical_homeloans = Tag.find_or_create_by(name: "Ethical Homeloans")
@tag_ethical_powershop = Tag.find_or_create_by(name: "Powershop")
@tag_ethical_energy_locals = Tag.find_or_create_by(name: "Energy Locals")
@tag_ethical_diamond_energy = Tag.find_or_create_by(name: "Diamond Energy")
@tag_ethical_good_super = Tag.find_or_create_by(name: "Good Super")
@tag_ethical_future_super = Tag.find_or_create_by(name: "Future Super")
@tag_ethical_australian_ethical = Tag.find_or_create_by(name: "Australian Ethical")
